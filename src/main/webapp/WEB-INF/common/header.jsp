...
<body>
	<div class="header_outside">
		...
		<div id="topBanner">
			...
			<span class="closeBtn"
				onclick="this.parentElement.style.display='none'"> <!-- 이벤트창 닫기 -->
				<a href="#none" title="이벤트 닫기"><img
					src="${contextPath}/resources/image/main/closeBtn.png" /></a>
			</span>
		</div>
		...
		<div class="header_inside">
			<div class="header_top_content">
				...
				<div class="header_logo">
					<a href="${contextPath}/main.do"> <img style="height: 80px"
						src="${contextPath}/resources/image/main/logo.png" />
					</a>
				</div>
