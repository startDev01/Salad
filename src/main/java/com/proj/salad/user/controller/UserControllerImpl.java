...
public class UserControllerImpl implements UserController {
	...
	public ModelAndView login(@RequestParam Map<String, String> loginMap,
			                  								HttpServletRequest request, HttpServletResponse response) throws Exception {  //@RequestParam("문자열")은 주소에 있는 특정 값을 가져옴
	...
	public ResponseEntity addUser(@ModelAttribute("userVO") UserVO userVO, 
